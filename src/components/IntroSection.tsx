  ...
  return (
    <section id="nosotros" className="py-[120px] lg:py-[180px] bg-main overflow-hidden">
      <div className="max-w-[1320px] mx-auto px-6 lg:px-[80px]">
        ...
        {/* Encabezado Superior (A lo largo) */}
        <div className="mb-20 lg:mb-28 max-w-[1000px]">
          <motion.div
            initial={{ opacity: 0 }}
          ...
          <motion.h2
            ...
            className="text-[40px] md:text-[56px] lg:text-[76px] font-bold text-main mb-10 text-pretty"
          ...
          <motion.p
            ...
            className="text-[20px] lg:text-[26px] text-main/90 mb-12 text-pretty"
          ...
          <div className="lg:col-span-7 flex flex-col w-full">
            {[
              ...
              <motion.div 
                ...
                className="group relative flex flex-col py-10 lg:py-14 transition-colors duration-500 outline-none first:pt-0"
                tabIndex={0}
              >
                {/* Línea Divisoria Superior (Omitida en el primero si queremos, pero la dejamos para consistencia) */}
                {index !== 0 && (
                  <motion.div 
                    initial={{ width: "0%" }}
